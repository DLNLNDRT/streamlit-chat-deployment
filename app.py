...
STREAMLIT_USERNAME = os.getenv("STREAMLIT_UI_USERNAME", "admin")
STREAMLIT_PASSWORD = os.getenv("STREAMLIT_UI_PASSWORD", "password123")
...
if "api_base" not in st.session_state:
    st.session_state.api_base = os.getenv("AGENT_API_BASE", "https://agent-service-w63c.onrender.com")
...
def authenticate_api(username: str, password: str) -> bool:
    ...
    # Use the agent API credentials, not the Streamlit UI credentials
    agent_username = os.getenv("AGENT_API_USERNAME", "admin")
    agent_password = os.getenv("AGENT_API_PASSWORD", "password123")
    try:
